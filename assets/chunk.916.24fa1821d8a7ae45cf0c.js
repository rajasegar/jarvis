...
try{n(e)}catch(t){try{return n.call(null,e)}catch(t){return n.call(this,e)}}}(e)}}function h(e,t){this.fun=e,this.array=t}function p(){}r.nextTick=function(e){var t=new Array(arguments.length-1)
...
var r,i=n(9142)
!function(){"use strict"
function o(e){return o="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},o(e)}function s(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function a(e,t){for(var n=0;n<t.length;n++){var r=t[n]
...
throw new Error("Unable to locate global object")}(),p=h.window,g=h.console,m=h.setTimeout,v=h.clearTimeout,b=p&&p.document,y=p&&p.navigator,k=function(){var e="qunit-test-string"
try{return h.sessionStorage.setItem(e,e),h.sessionStorage.removeItem(e),h.sessionStorage}catch(e){return}}(),w="function"==typeof h.Map&&"function"==typeof h.Map.prototype.keys&&"function"==typeof h.Symbol&&"symbol"===o(h.Symbol.iterator)?h.Map:function(e){var t=this,n=Object.create(null),r=Object.prototype.hasOwnProperty
...
return Array.isArray(e)&&e.forEach((function(e){t[e]=!0})),{add:function(e){t[e]=!0},has:function(e){return e in t},get size(){return Object.keys(t).length}}},E={warn:g?Function.prototype.bind.call(g.warn||g.log,g):function(){}},T=Object.prototype.toString,C=Object.prototype.hasOwnProperty,N=p&&void 0!==p.performance&&"function"==typeof p.performance.mark&&"function"==typeof p.performance.measure?p.performance:void 0,M={now:N?N.now.bind(N):Date.now,measure:N?function(e,t,n){try{N.measure(e,t,n)}catch(e){E.warn("performance.measure could not be executed because of ",e.message)}}:function(){},mark:N?N.mark.bind(N):function(){}}
function S(e,t){return e.filter((function(e){return-1===t.indexOf(e)}))}function j(e,t){return-1!==t.indexOf(e)}function q(e){var t=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=t&&_("array",e)?[]:{}
for(var r in e)if(C.call(e,r)){var i=e[r]
n[r]=i===Object(i)?q(i,t):i}return n}function I(e,t){if(e!==Object(e))return e
var n={}
for(var r in t)C.call(t,r)&&C.call(e,r)&&(n[r]=I(e[r],t[r]))
...
default:return o(e)}}function _(e,t){return O(t)===e}function A(e,t){for(var n=e+""+t,r=0,i=0;i<n.length;i++)r=(r<<5)-r+n.charCodeAt(i),r|=0
var o=(4294967296+r).toString(16)
return o.length<8&&(o="0000000"+o),o.slice(-8)}function L(e){var t=String(e)
return"[object"===t.slice(0,7)?(e.name||"Error")+(e.message?": ".concat(e.message):""):t}var P=new x(["boolean","number","string"]),H=[]
function U(e,t){return e===t}function D(e,t){return e===t||e.valueOf()===t.valueOf()}function F(e){var t=Object.getPrototypeOf(e)
return t&&null!==t.constructor?e.constructor:Object}function B(e){return"flags"in e?e.flags:e.toString().match(/[gimuy]*$/)[0]}var Q={undefined:U,null:U,boolean:D,number:function(e,t){return e===t||e.valueOf()===t.valueOf()||isNaN(e.valueOf())&&isNaN(t.valueOf())},string:D,symbol:U,date:D,nan:function(){return!0},regexp:function(e,t){return e.source===t.source&&B(e)===B(t)},function:U,array:function(e,t){if(e.length!==t.length)return!1
...
H=[],$(t,e)&&(r=!0),H=n}})),r||(n=!1)}})),n},map:function(e,t){if(e.size!==t.size)return!1
var n=!0
return e.forEach((function(e,r){if(n){var i=!1
t.forEach((function(t,n){if(!i){var o=H
H=[],Q.array([t,n],[e,r])&&(i=!0),H=o}})),i||(n=!1)}})),n}},z={undefined:U,null:U,boolean:U,number:function(e,t){return e===t||isNaN(e)&&isNaN(t)},string:U,symbol:U,function:U,object:function(e,t){if(H.some((function(n){return n.a===e&&n.b===t})))return!0
H.push({a:e,b:t})
var n=O(e),r=O(t)
...
return H=[],n}function Y(e,t){if(2===arguments.length)return e===t||G(e,t)
for(var n=arguments.length-1;n>0;){if(!G(arguments[n-1],arguments[n]))return!1
n--}return!0}var W={altertitle:!0,collapse:!0,failOnZeroTests:!0,filter:void 0,maxDepth:5,module:void 0,moduleId:void 0,reorder:!0,requireExpects:!1,scrolltop:!0,storage:k,testId:void 0,urlConfig:[],currentModule:{name:"",tests:[],childModules:[],testsRun:0,testsIgnored:0,hooks:{before:[],beforeEach:[],afterEach:[],after:[]}},globalHooks:{},blocking:!0,callbacks:{},modules:[],queue:[],stats:{all:0,bad:0,testCount:0}},J=h&&h.QUnit&&!h.QUnit.version&&h.QUnit.config
J&&R(W,J),W.modules.push(W.currentModule)
...
return t=null===e?"null":void 0===e?"undefined":_("regexp",e)?"regexp":_("date",e)?"date":_("function",e)?"function":void 0!==e.setInterval&&void 0!==e.document&&void 0===e.nodeType?"window":9===e.nodeType?"document":e.nodeType?"node":function(e){return"[object Array]"===T.call(e)||"number"==typeof e.length&&void 0!==e.item&&(e.length?e.item(0)===e[0]:null===e.item(0)&&void 0===e[0])}(e)?"array":e.constructor===Error.prototype.constructor?"error":o(e),t},separator:function(){return this.multiline?this.HTML?"<br />":"\n":this.HTML?"&#160;":" "},indent:function(e){if(!this.multiline)return""
...
return s}(),Z=function(){function e(t,n){s(this,e),this.name=t,this.fullName=n?n.fullName.concat(t):[],this.globalFailureCount=0,this.tests=[],this.childSuites=[],n&&n.pushChildSuite(this)}return u(e,[{key:"start",value:function(e){if(e){this._startTime=M.now()
var t=this.fullName.length
M.mark("qunit_suite_".concat(t,"_start"))}return{name:this.name,fullName:this.fullName.slice(),tests:this.tests.map((function(e){return e.start()})),childSuites:this.childSuites.map((function(e){return e.start()})),testCounts:{total:this.getTestCounts().total}}}},{key:"end",value:function(e){if(e){this._endTime=M.now()
var t=this.fullName.length,n=this.fullName.join(" – ")
M.mark("qunit_suite_".concat(t,"_end")),M.measure(0===t?"QUnit Test Run":"QUnit Test Suite: ".concat(n),"qunit_suite_".concat(t,"_start"),"qunit_suite_".concat(t,"_end"))}return{name:this.name,fullName:this.fullName.slice(),tests:this.tests.map((function(e){return e.end()})),childSuites:this.childSuites.map((function(e){return e.end()})),testCounts:this.getTestCounts(),runtime:this.getRuntime(),status:this.getStatus()}}},{key:"pushChildSuite",value:function(e){this.childSuites.push(e)}},{key:"pushTest",value:function(e){this.tests.push(e)}},{key:"getRuntime",value:function(){return Math.round(this._endTime-this._startTime)}},{key:"getTestCounts",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{passed:0,failed:0,skipped:0,todo:0,total:0}
return e.failed+=this.globalFailureCount,e.total+=this.globalFailureCount,e=this.tests.reduce((function(e,t){return t.valid&&(e[t.getStatus()]++,e.total++),e}),e),this.childSuites.reduce((function(e,t){return t.getTestCounts(e)}),e)}},{key:"getStatus",value:function(){var e=this.getTestCounts(),t=e.total,n=e.failed,r=e.skipped,i=e.todo
return n?"failed":r===t?"skipped":i===t?"todo":"passed"}}]),e}(),K=[],X=new Z
function ee(e,t,n){var r=K.length?K.slice(-1)[0]:null,i=null!==r?[r.name,e].join(" > "):e,o=r?r.suiteReport:X,s=null!==r&&r.skip||n.skip,a=null!==r&&r.todo||n.todo,u={}
r&&R(u,r.testEnvironment),R(u,t)
var l={name:i,parentModule:r,hooks:{before:[],beforeEach:[],afterEach:[],after:[]},testEnvironment:u,tests:[],moduleId:A(i),testsRun:0,testsIgnored:0,childModules:[],suiteReport:new Z(e,o),stats:null,skip:s,todo:!s&&a,ignored:n.ignored||!1}
return r&&r.childModules.push(l),W.modules.push(l),l}function te(e,t,n){var r=t[n]
"function"==typeof r&&e[n].push(r),delete t[n]}function ne(e,t){return function(n){W.currentModule!==e&&E.warn("The `"+t+"` hook was called inside the wrong module (`"+W.currentModule.name+"`). Instead, use hooks provided by the callback to the containing module (`"+e.name+"`). This will become an error in QUnit 3.0."),e.hooks[t].push(n)}}function re(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{}
"function"==typeof t&&(n=t,t=void 0)
var i=ee(e,t,r),o=i.testEnvironment,s=i.hooks
te(s,o,"before"),te(s,o,"beforeEach"),te(s,o,"afterEach"),te(s,o,"after")
var a={before:ne(i,"before"),beforeEach:ne(i,"beforeEach"),afterEach:ne(i,"afterEach"),after:ne(i,"after")},u=W.currentModule
if(W.currentModule=i,"function"==typeof n){K.push(i)
try{var l=n.call(i.testEnvironment,a)
l&&"function"==typeof l.then&&E.warn("Returning a promise from a module callback is not supported. Instead, use hooks for async behavior. This will become an error in QUnit 3.0.")}finally{K.pop(),W.currentModule=i.parentModule||u}}}var ie=!1
function oe(e,t,n){var r,i=ie&&(r=W.modules.filter((function(e){return!e.ignored})).map((function(e){return e.moduleId})),!K.some((function(e){return r.includes(e.moduleId)})))
re(e,t,n,{ignored:i})}oe.only=function(){ie||(W.modules.length=0,W.queue.length=0,W.currentModule.ignored=!0),ie=!0,re.apply(void 0,arguments)},oe.skip=function(e,t,n){ie||re(e,t,n,{skip:!0})},oe.todo=function(e,t,n){ie||re(e,t,n,{todo:!0})}
var se=(ue(0)||"").replace(/(:\d+)+\)?/,"").replace(/.+[/\\]/,"")
function ae(e,t){if(t=void 0===t?4:t,e&&e.stack){var n=e.stack.split("\n")
if(/^error$/i.test(n[0])&&n.shift(),se){for(var r=[],i=t;i<n.length&&-1===n[i].indexOf(se);i++)r.push(n[i])
if(r.length)return r.join("\n")}return n[t]}}function ue(e){var t=new Error
if(!t.stack)try{throw t}catch(e){t=e}return ae(t,e)}var le=function(){function e(t){s(this,e),this.test=t}return u(e,[{key:"timeout",value:function(e){if("number"!=typeof e)throw new Error("You must pass a number as the duration to assert.timeout")
...
return this.test.internalStop(t)}},{key:"push",value:function(t,n,r,i,o){return E.warn("assert.push is deprecated and will be removed in QUnit 3.0. Please use assert.pushResult instead (https://api.qunitjs.com/assert/pushResult)."),(this instanceof e?this:W.current.assert).pushResult({result:t,actual:n,expected:r,message:i,negative:o})}},{key:"pushResult",value:function(t){var n=this,r=n instanceof e&&n.test||W.current
if(!r)throw new Error("assertion outside test context, in "+ue(2))
return n instanceof e||(n=r.assert),n.test.pushResult(t)}},{key:"ok",value:function(e,t){t||(t=e?"okay":"failed, expected argument to be truthy, was: ".concat(V.parse(e))),this.pushResult({result:!!e,actual:e,expected:!0,message:t})}},{key:"notOk",value:function(e,t){t||(t=e?"failed, expected argument to be falsy, was: ".concat(V.parse(e)):"okay"),this.pushResult({result:!e,actual:e,expected:!1,message:t})}},{key:"true",value:function(e,t){this.pushResult({result:!0===e,actual:e,expected:!0,message:t})}},{key:"false",value:function(e,t){this.pushResult({result:!1===e,actual:e,expected:!1,message:t})}},{key:"equal",value:function(e,t,n){this.pushResult({result:t==e,actual:e,expected:t,message:n})}},{key:"notEqual",value:function(e,t,n){this.pushResult({result:t!=e,actual:e,expected:t,message:n,negative:!0})}},{key:"propEqual",value:function(e,t,n){e=q(e),t=q(t),this.pushResult({result:Y(e,t),actual:e,expected:t,message:n})}},{key:"notPropEqual",value:function(e,t,n){e=q(e),t=q(t),this.pushResult({result:!Y(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"propContains",value:function(e,t,n){e=I(e,t),t=q(t,!1),this.pushResult({result:Y(e,t),actual:e,expected:t,message:n})}},{key:"notPropContains",value:function(e,t,n){e=I(e,t),t=q(t),this.pushResult({result:!Y(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"deepEqual",value:function(e,t,n){this.pushResult({result:Y(e,t),actual:e,expected:t,message:n})}},{key:"notDeepEqual",value:function(e,t,n){this.pushResult({result:!Y(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"strictEqual",value:function(e,t,n){this.pushResult({result:t===e,actual:e,expected:t,message:n})}},{key:"notStrictEqual",value:function(e,t,n){this.pushResult({result:t!==e,actual:e,expected:t,message:n,negative:!0})}},{key:"throws",value:function(t,n,r){var i=l(ce(n,r,"throws"),2)
n=i[0],r=i[1]
var o=this instanceof e&&this.test||W.current
if("function"==typeof t){var s,a=!1
o.ignoreGlobalErrors=!0
try{t.call(o.testEnvironment)}catch(e){s=e}if(o.ignoreGlobalErrors=!1,s){var u=l(fe(s,n,r),3)
a=u[0],n=u[1],r=u[2]}o.assert.pushResult({result:a,actual:s&&L(s),expected:n,message:r})}else o.assert.pushResult({result:!1,actual:t,message:'The value provided to `assert.throws` in "'+o.testName+'" was not a function.'})}},{key:"rejects",value:function(t,n,r){var i=l(ce(n,r,"rejects"),2)
n=i[0],r=i[1]
var o=this instanceof e&&this.test||W.current,s=t&&t.then
if("function"==typeof s){var a=this.async()
return s.call(t,(function(){o.assert.pushResult({result:!1,message:'The promise returned by the `assert.rejects` callback in "'+o.testName+'" did not reject.',actual:t}),a()}),(function(e){var t,i=l(fe(e,n,r),3)
t=i[0],n=i[1],r=i[2],o.assert.pushResult({result:t,actual:e&&L(e),expected:n,message:r}),a()}))}o.assert.pushResult({result:!1,message:'The value provided to `assert.rejects` in "'+o.testName+'" was not a promise.',actual:t})}}]),e}()
function ce(e,t,n){var r=O(e)
if("string"===r){if(void 0===t)return t=e,[e=void 0,t]
throw new Error("assert."+n+" does not accept a string value for the expected argument.\nUse a non-string object value (e.g. RegExp or validator function) instead if necessary.")}if(e&&"regexp"!==r&&"function"!==r&&"object"!==r)throw new Error("Invalid expected value type ("+r+") provided to assert."+n+".")
return[e,t]}function fe(e,t,n){var r=!1,i=O(t)
...
return[r,t,n]}le.prototype.raises=le.prototype.throws
var de=Object.create(null),he=["error","runStart","suiteStart","testStart","assertion","testEnd","suiteEnd","runEnd"]
function pe(e,t){if("string"!=typeof e)throw new TypeError("eventName must be a string when emitting an event")
for(var n=de[e],r=n?c(n):[],i=0;i<r.length;i++)r[i](t)}var ge="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==n.g?n.g:"undefined"!=typeof self?self:{}
function me(e){throw new Error('Could not dynamically require "'+e+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}var ve={exports:{}}
...
for(var o=0,s=e.length;o<s;o++)i.resolve(e[o]).then(t,r)}))},i._immediateFn="function"==typeof setImmediate&&function(e){setImmediate(e)}||function(e){t(e,0)},i._unhandledRejectionFn=function(e){"undefined"!=typeof console&&console&&console.warn("Possible Unhandled Promise Rejection:",e)},ve.exports=i}else ve.exports=e.Promise
...
n=!0,u(t,e)}}}()
var be=ve.exports
function ye(e,t){var n=W.callbacks[e]
if("log"!==e){var r=be.resolve()
return n.forEach((function(e){r=r.then((function(){return be.resolve(e(t))}))})),r}n.map((function(e){return e(t)}))}var ke,we=0,xe=[]
function Ee(){var e,t
e=M.now(),W.depth=(W.depth||0)+1,Te(e),W.depth--,xe.length||W.blocking||W.current||(W.blocking||W.queue.length||0!==W.depth?(t=W.queue.shift()(),xe.push.apply(xe,c(t)),we>0&&we--,Ee()):function(){var e
if(0===W.stats.testCount&&!0===W.failOnZeroTests)return e=W.filter&&W.filter.length?new Error('No tests matched the filter "'.concat(W.filter,'".')):W.module&&W.module.length?new Error('No tests matched the module "'.concat(W.module,'".')):W.moduleId&&W.moduleId.length?new Error('No tests matched the moduleId "'.concat(W.moduleId,'".')):W.testId&&W.testId.length?new Error('No tests matched the testId "'.concat(W.testId,'".')):new Error("No tests were run."),Oe("global failure",R((function(t){t.pushResult({result:!1,message:e.message,source:e.stack})}),{validTest:!0})),void Ee()
var t=W.storage,n=Math.round(M.now()-W.started),r=W.stats.all-W.stats.bad
Ce.finished=!0,pe("runEnd",X.end(!0)),ye("done",{passed:r,failed:W.stats.bad,total:W.stats.all,runtime:n}).then((function(){if(t&&0===W.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
0===n.indexOf("qunit-test-")&&t.removeItem(n)}}))}())}function Te(e){if(xe.length&&!W.blocking){var t=M.now()-e
if(!m||W.updateRate<=0||t<W.updateRate){var n=xe.shift()
be.resolve(n()).then((function(){xe.length?Te(e):Ee()}))}else m(Ee)}}var Ce={finished:!1,add:function(e,t,n){if(t)W.queue.splice(we++,0,e)
else if(n){ke||(ke=function(e){var t=parseInt(A(e),16)||-1
return function(){return t^=t<<13,t^=t>>>17,(t^=t<<5)<0&&(t+=4294967296),t/4294967296}}(n))
var r=Math.floor(ke()*(W.queue.length-we+1))
W.queue.splice(we+r,0,e)}else W.queue.push(e)},advance:Ee,taskCount:function(){return xe.length}},Ne=function(){function e(t,n,r){s(this,e),this.name=t,this.suiteName=n.name,this.fullName=n.fullName.concat(t),this.runtime=0,this.assertions=[],this.skipped=!!r.skip,this.todo=!!r.todo,this.valid=r.valid,this._startTime=0,this._endTime=0,n.pushTest(this)}return u(e,[{key:"start",value:function(e){return e&&(this._startTime=M.now(),M.mark("qunit_test_start")),{name:this.name,suiteName:this.suiteName,fullName:this.fullName.slice()}}},{key:"end",value:function(e){if(e&&(this._endTime=M.now(),M)){M.mark("qunit_test_end")
var t=this.fullName.join(" – ")
M.measure("QUnit Test: ".concat(t),"qunit_test_start","qunit_test_end")}return R(this.start(),{runtime:this.getRuntime(),status:this.getStatus(),errors:this.getFailedAssertions(),assertions:this.getAssertions()})}},{key:"pushAssertion",value:function(e){this.assertions.push(e)}},{key:"getRuntime",value:function(){return Math.round(this._endTime-this._startTime)}},{key:"getStatus",value:function(){return this.skipped?"skipped":(this.getFailedAssertions().length>0?this.todo:!this.todo)?this.todo?"todo":"passed":"failed"}},{key:"getFailedAssertions",value:function(){return this.assertions.filter((function(e){return!e.passed}))}},{key:"getAssertions",value:function(){return this.assertions.slice()}},{key:"slimAssertions",value:function(){this.assertions=this.assertions.map((function(e){return delete e.actual,delete e.expected,e}))}}]),e}()
function Me(e){if(this.expected=null,this.assertions=[],this.module=W.currentModule,this.steps=[],this.timeout=void 0,this.data=void 0,this.withData=!1,this.pauses=new w,this.nextPauseId=1,this.stackOffset=3,R(this,e),this.module.skip?(this.skip=!0,this.todo=!1):this.module.todo&&!this.skip&&(this.todo=!0),Ce.finished)E.warn("Unexpected test after runEnd. This is unstable and will fail in QUnit 3.0.")
...
this.testId=A(this.module.name,this.testName),++Me.count,this.errorForStack=new Error,this.callback&&this.callback.validTest&&(this.errorForStack.stack=void 0),this.testReport=new Ne(this.testName,this.module.suiteReport,{todo:this.todo,skip:this.skip,valid:this.valid()}),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new le(this)}}function Se(){if(!W.current)throw new Error("pushFailure() assertion outside test context, in "+ue(2))
var e=W.current
...
W.pollution.push(e)}}Me.count=0,Me.prototype={get stack(){return ae(this.errorForStack,this.stackOffset)},before:function(){var e=this,t=this.module,n=function(e){for(var t=e,n=[];t&&0===t.testsRun;)n.push(t),t=t.parentModule
return n.reverse()}(t),r=be.resolve()
return n.forEach((function(e){r=r.then((function(){return e.stats={all:0,bad:0,started:M.now()},pe("suiteStart",e.suiteReport.start(!0)),ye("moduleStart",{name:e.name,tests:e.tests})}))})),r.then((function(){return W.current=e,e.testEnvironment=R({},t.testEnvironment),e.started=M.now(),pe("testStart",e.testReport.start(!0)),ye("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){W.pollution||je()}))}))},run:function(){if(W.current=this,W.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+": "+(e.message||e)+"\n"+this.stack,ae(e,0)),je(),W.blocking&&Le(this)}function e(e){var t
t=e.withData?e.callback.call(e.testEnvironment,e.assert,e.data):e.callback.call(e.testEnvironment,e.assert),e.resolvePromise(t),0===e.timeout&&e.pauses.size>0&&Se("Test did not finish synchronously even though assert.timeout( 0 ) was used.",ue(2))}},after:function(){!function(){var e=W.pollution
je()
...
else try{r=e.call(n.testEnvironment,n.assert)}catch(e){return void n.pushFailure("Global "+t+" failed on "+n.testName+": "+L(e),ae(e,0))}n.resolvePromise(r,t)}},queueHook:function(e,t,n){var r=this,i=function(){var n=e.call(r.testEnvironment,r.assert)
...
i?De(t):function(e){for(e.testsRun++;e=e.parentModule;)e.testsRun++}(t),a&&(s?a.setItem("qunit-test-"+n+"-"+r,s):a.removeItem("qunit-test-"+n+"-"+r)),pe("testEnd",this.testReport.end(!0)),this.testReport.slimAssertions()
var l=this
return ye("testDone",{name:r,module:n,skipped:i,todo:o,failed:s,passed:this.assertions.length-s,total:this.assertions.length,runtime:i?0:this.runtime,assertions:this.assertions,testId:this.testId,get source(){return l.stack}}).then((function(){if(Ue(t)){for(var e=[t],n=t.parentModule;n&&Ue(n);)e.push(n),n=n.parentModule
var r=be.resolve()
return e.forEach((function(e){r=r.then((function(){return function(e){for(var t=[e];t.length;){var n=t.shift()
n.hooks={},t.push.apply(t,c(n.childModules))}return pe("suiteEnd",e.suiteReport.end(!0)),ye("moduleDone",{name:e.name,tests:e.tests,failed:e.stats.bad,passed:e.stats.all-e.stats.bad,total:e.stats.all,runtime:Math.round(M.now()-e.stats.started)})}(e)}))})),r}})).then((function(){W.current=void 0}))},preserveTestEnvironment:function(){this.preserveEnvironment&&(this.module.testEnvironment=this.testEnvironment,this.testEnvironment=R({},this.module.testEnvironment))},queue:function(){var e=this
if(this.valid()){var t=W.storage&&+W.storage.getItem("qunit-test-"+this.module.name+"-"+this.testName),n=W.reorder&&!!t
this.previousFailure=!!t,Ce.add((function(){return[function(){return e.before()}].concat(c(e.hooks("before")),[function(){e.preserveTestEnvironment()}],c(e.hooks("beforeEach")),[function(){e.run()}],c(e.hooks("afterEach").reverse()),c(e.hooks("after").reverse()),[function(){e.after()},function(){return e.finish()}])}),n,W.seed)}else De(this.module)},pushResult:function(e){if(this!==W.current){var t=e&&e.message||"",n=this&&this.testName||""
throw new Error("Assertion occurred after test finished.\n> Test: "+n+"\n> Message: "+t+"\n")}var r={module:this.module.name,name:this.testName,result:e.result,message:e.message,actual:e.actual,testId:this.testId,negative:e.negative||!1,runtime:Math.round(M.now()-this.started),todo:!!this.todo}
if(C.call(e,"expected")&&(r.expected=e.expected),!e.result){var i=e.source||ue()
i&&(r.source=i)}this.logAssertion(r),this.assertions.push({result:!!e.result,message:e.message})},pushFailure:function(e,t,n){if(!(this instanceof Me))throw new Error("pushFailure() assertion outside test context, was "+ue(2))
this.pushResult({result:!1,message:e||"error",actual:n||null,source:t})},logAssertion:function(e){ye("log",e)
var t={passed:e.result,actual:e.actual,expected:e.expected,message:e.message,stack:e.source,todo:e.todo}
this.testReport.pushAssertion(t),pe("assertion",t)},internalResetTimeout:function(e){v(W.timeout),W.timeout=m(W.timeoutHandler(e),e)},internalStop:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1
W.blocking=!0
var t,n=this,r=this.nextPauseId++,i={cancelled:!1,remaining:e}
function o(){if(!i.cancelled){if(void 0===W.current)throw new Error("Unexpected release of async pause after tests finished.\n"+"> Test: ".concat(n.testName," [async #").concat(r,"]"))
...
i.remaining--,0===i.remaining&&n.pauses.delete(r),Pe(n)}}return n.pauses.set(r,i),m&&("number"==typeof n.timeout?t=n.timeout:"number"==typeof W.testTimeout&&(t=W.testTimeout),"number"==typeof t&&t>0&&(W.timeoutHandler=function(e){return function(){W.timeout=null,i.cancelled=!0,n.pauses.delete(r),n.pushFailure("Test took longer than ".concat(e,"ms; test timed out."),ue(2)),Pe(n)}},v(W.timeout),W.timeout=m(W.timeoutHandler(t),t))),o},resolvePromise:function(e,t){if(null!=e){var n=this,r=e.then
...
n.pushFailure(r,ae(e,0)),je(),Le(n)}))}}},valid:function(){if(this.callback&&this.callback.validTest)return!0
...
var qe=!1
function Ie(e){qe||W.currentModule.ignored||new Me(e).queue()}function Re(e){W.currentModule.ignored||(qe||(W.queue.length=0,qe=!0),new Me(e).queue())}function Oe(e,t){Ie({testName:e,callback:t})}function _e(e,t){return"".concat(e," [").concat(t,"]")}function Ae(e,t){if(Array.isArray(e))for(var n=0;n<e.length;n++)t(e[n],n)
else{if("object"!==o(e)||null===e)throw new Error("test.each() expects an array or object as input, but\nfound ".concat(o(e)," instead."))
for(var r in e)t(e[r],r)}}function Le(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),Pe(e)}function Pe(e){e.pauses.size>0||(m?(v(W.timeout),W.timeout=m((function(){e.pauses.size>0||(v(W.timeout),W.timeout=null,W.blocking=!1,Ce.advance())}))):(W.blocking=!1,Ce.advance()))}function He(e){for(var t=[].concat(e.tests),n=c(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,c(r.childModules))}return t}function Ue(e){return e.testsRun+e.testsIgnored===He(e).length}function De(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}R(Oe,{todo:function(e,t){Ie({testName:e,callback:t,todo:!0})},skip:function(e){Ie({testName:e,skip:!0})},only:function(e,t){Re({testName:e,callback:t})},each:function(e,t,n){Ae(t,(function(t,r){Ie({testName:_e(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}}),Oe.todo.each=function(e,t,n){Ae(t,(function(t,r){Ie({testName:_e(e,r),callback:n,todo:!0,withData:!0,stackOffset:5,data:t})}))},Oe.skip.each=function(e,t){Ae(t,(function(t,n){Ie({testName:_e(e,n),stackOffset:5,skip:!0})}))},Oe.only.each=function(e,t,n){Ae(t,(function(t,r){Re({testName:_e(e,r),callback:n,withData:!0,stackOffset:5,data:t})}))}
var Fe,Be,Qe,ze,$e=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
s(this,e),this.log=n.log||Function.prototype.bind.call(g.log,g),t.on("error",this.onError.bind(this)),t.on("runStart",this.onRunStart.bind(this)),t.on("testStart",this.onTestStart.bind(this)),t.on("testEnd",this.onTestEnd.bind(this)),t.on("runEnd",this.onRunEnd.bind(this))}return u(e,[{key:"onError",value:function(e){this.log("error",e)}},{key:"onRunStart",value:function(e){this.log("runStart",e)}},{key:"onTestStart",value:function(e){this.log("testStart",e)}},{key:"onTestEnd",value:function(e){this.log("testEnd",e)}},{key:"onRunEnd",value:function(e){this.log("runEnd",e)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}(),Ge=!0
if(void 0!==i){var Ye=i.env||{}
Fe=Ye.FORCE_COLOR,Be=Ye.NODE_DISABLE_COLORS,Qe=Ye.NO_COLOR,ze=Ye.TERM,Ge=i.stdout&&i.stdout.isTTY}var We={enabled:!Be&&null==Qe&&"dumb"!==ze&&(null!=Fe&&"0"!==Fe||Ge),reset:Ve(0,0),bold:Ve(1,22),dim:Ve(2,22),italic:Ve(3,23),underline:Ve(4,24),inverse:Ve(7,27),hidden:Ve(8,28),strikethrough:Ve(9,29),black:Ve(30,39),red:Ve(31,39),green:Ve(32,39),yellow:Ve(33,39),blue:Ve(34,39),magenta:Ve(35,39),cyan:Ve(36,39),white:Ve(37,39),gray:Ve(90,39),grey:Ve(90,39),bgBlack:Ve(40,49),bgRed:Ve(41,49),bgGreen:Ve(42,49),bgYellow:Ve(43,49),bgBlue:Ve(44,49),bgMagenta:Ve(45,49),bgCyan:Ve(46,49),bgWhite:Ve(47,49)}
...
return"|\n"+c.join("\n")}var f=e.split("\n").map((function(e){return a+e}))
return"|+\n"+f.join("\n")}return e}return JSON.stringify(Xe(e),null,2)}function Xe(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[]
if(-1!==t.indexOf(e))return"[Circular]"
var n,r=Object.prototype.toString.call(e).replace(/^\[.+\s(.+?)]$/,"$1").toLowerCase()
switch(r){case"array":t.push(e),n=e.map((function(e){return Xe(e,t)})),t.pop()
break
case"object":t.push(e),n={},Object.keys(e).forEach((function(r){n[r]=Xe(e[r],t)})),t.pop()
break
default:n=e}return n}var et=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
s(this,e),this.log=n.log||Function.prototype.bind.call(g.log,g),this.testCount=0,this.ended=!1,this.bailed=!1,t.on("error",this.onError.bind(this)),t.on("runStart",this.onRunStart.bind(this)),t.on("testEnd",this.onTestEnd.bind(this)),t.on("runEnd",this.onRunEnd.bind(this))}return u(e,[{key:"onRunStart",value:function(e){this.log("TAP version 13")}},{key:"onError",value:function(e){this.bailed||(this.bailed=!0,this.ended||(this.testCount=this.testCount+1,this.log(We.red("not ok ".concat(this.testCount," global failure"))),this.logError(e)),this.log("Bail out! "+L(e).split("\n")[0]),this.ended&&this.logError(e))}},{key:"onTestEnd",value:function(e){var t=this
...
t+="\n  message: ".concat(Ke(L(e))),t+="\n  severity: ".concat(Ke("failed")),e&&e.stack&&(t+="\n  stack: ".concat(Ke(e.stack+"\n"))),t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}(),tt={console:$e,tap:et}
function nt(e){return function(t){W.globalHooks[e]||(W.globalHooks[e]=[]),W.globalHooks[e].push(t)}}var rt={beforeEach:nt("beforeEach"),afterEach:nt("afterEach")}
function it(e){W.current?W.current.assert.pushResult({result:!1,message:"global failure: ".concat(L(e)),source:e&&e.stack||ue(2)}):(X.globalFailureCount++,W.stats.bad++,W.stats.all++,pe("error",e))}var ot={}
...
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,it(t),!1},onUncaughtException:it,pushFailure:Se,assert:le.prototype,module:oe,test:Oe,todo:Oe.todo,skip:Oe.skip,only:Oe.only,start:function(e){if(W.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=st
...
if(!W.pageLoaded)return W.autostart=!0,void(b||ot.load())
ut()},onUnhandledRejection:function(e){E.warn("QUnit.onUnhandledRejection is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),it(e)},extend:function(){E.warn("QUnit.extend is deprecated and will be removed in QUnit 3.0. Please use Object.assign instead.")
for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n]
return R.apply(this,t)},load:function(){W.pageLoaded=!0,R(W,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),at||(W.blocking=!1,W.autostart&&ut())},stack:function(e){return ue(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
...
void 0===W.callbacks[i]&&(W.callbacks[i]=[]),e[i]=n(i)}}(ot),function(i){if(p&&b){if(p.QUnit&&p.QUnit.version)throw new Error("QUnit has already been defined.")
p.QUnit=i}e&&e.exports&&(e.exports=i,e.exports.QUnit=i),t&&(t.QUnit=i),void 0===(r=function(){return i}.call(t,n,t,e))||(e.exports=r),i.config.autostart=!1}(ot),function(){if(p&&b){var e=ot.config,t=Object.prototype.hasOwnProperty
ot.begin((function(){if(!t.call(e,"fixture")){var n=b.getElementById("qunit-fixture")
n&&(e.fixture=n.cloneNode(!0))}})),ot.testStart((function(){if(null!=e.fixture){var t=b.getElementById("qunit-fixture")
if("string"===o(e.fixture)){var n=b.createElement("div")
...
var ft={exports:{}}
!function(e){var t,n
t=ge,n=function(){var e=void 0!==me&&"undefined"==typeof window,t="function"==typeof Map?Map:function(){var e=Object.create(null)
...
return function t(o){var p={single:function(e,t,n){return"farzher"==e?{target:"farzher was here (^-^*)/",score:0,indexes:[0,1,2,3,4,5,6]}:e?(f(e)||(e=p.getPreparedSearch(e)),t?(f(t)||(t=p.getPrepared(t)),((n&&void 0!==n.allowTypo?n.allowTypo:!o||void 0===o.allowTypo||o.allowTypo)?p.algorithm:p.algorithmNoTypo)(e,t,e[0])):null):null},go:function(e,t,n){if("farzher"==e)return[{target:"farzher was here (^-^*)/",score:0,indexes:[0,1,2,3,4,5,6],obj:t?t[0]:null}]
if(!e)return i
var r=(e=p.prepareSearch(e))[0],s=n&&n.threshold||o&&o.threshold||-9007199254740991,a=n&&n.limit||o&&o.limit||9007199254740991,u=(n&&void 0!==n.allowTypo?n.allowTypo:!o||void 0===o.allowTypo||o.allowTypo)?p.algorithm:p.algorithmNoTypo,d=0,g=0,m=t.length
if(n&&n.keys)for(var v=n.scoreFn||l,b=n.keys,y=b.length,k=m-1;k>=0;--k){for(var w=t[k],x=new Array(y),E=y-1;E>=0;--E)(N=c(w,C=b[E]))?(f(N)||(N=p.getPrepared(N)),x[E]=u(e,N,r)):x[E]=null
x.obj=w
var T=v(x)
null!==T&&(T<s||(x.score=T,d<a?(h.add(x),++d):(++g,T>h.peek().score&&h.replaceTop(x))))}else if(n&&n.key){var C=n.key
for(k=m-1;k>=0;--k)(N=c(w=t[k],C))&&(f(N)||(N=p.getPrepared(N)),null!==(M=u(e,N,r))&&(M.score<s||(M={target:M.target,_targetLowerCodes:null,_nextBeginningIndexes:null,score:M.score,indexes:M.indexes,obj:w},d<a?(h.add(M),++d):(++g,M.score>h.peek().score&&h.replaceTop(M)))))}else for(k=m-1;k>=0;--k){var N,M;(N=t[k])&&(f(N)||(N=p.getPrepared(N)),null!==(M=u(e,N,r))&&(M.score<s||(d<a?(h.add(M),++d):(++g,M.score>h.peek().score&&h.replaceTop(M)))))}if(0===d)return i
var S=new Array(d)
...
if(!t)return a(i)
var h=(t=p.prepareSearch(t))[0],g=d(),m=n.length-1,v=r&&r.threshold||o&&o.threshold||-9007199254740991,b=r&&r.limit||o&&o.limit||9007199254740991,y=(r&&void 0!==r.allowTypo?r.allowTypo:!o||void 0===o.allowTypo||o.allowTypo)?p.algorithm:p.algorithmNoTypo,k=0,w=0
function x(){if(s)return u("canceled")
var o=Date.now()
if(r&&r.keys)for(var d=r.scoreFn||l,E=r.keys,T=E.length;m>=0;--m){if(m%1e3==0&&Date.now()-o>=10)return void(e?setImmediate(x):setTimeout(x))
for(var C=n[m],N=new Array(T),M=T-1;M>=0;--M)(q=c(C,j=E[M]))?(f(q)||(q=p.getPrepared(q)),N[M]=y(t,q,h)):N[M]=null
N.obj=C
var S=d(N)
null!==S&&(S<v||(N.score=S,k<b?(g.add(N),++k):(++w,S>g.peek().score&&g.replaceTop(N))))}else if(r&&r.key)for(var j=r.key;m>=0;--m){if(m%1e3==0&&Date.now()-o>=10)return void(e?setImmediate(x):setTimeout(x));(q=c(C=n[m],j))&&(f(q)||(q=p.getPrepared(q)),null!==(I=y(t,q,h))&&(I.score<v||(I={target:I.target,_targetLowerCodes:null,_nextBeginningIndexes:null,score:I.score,indexes:I.indexes,obj:C},k<b?(g.add(I),++k):(++w,I.score>g.peek().score&&g.replaceTop(I)))))}else for(;m>=0;--m){if(m%1e3==0&&Date.now()-o>=10)return void(e?setImmediate(x):setTimeout(x))
var q,I;(q=n[m])&&(f(q)||(q=p.getPrepared(q)),null!==(I=y(t,q,h))&&(I.score<v||(k<b?(g.add(I),++k):(++w,I.score>g.peek().score&&g.replaceTop(I)))))}if(0===k)return a(i)
...
case"<":return"&lt;"
case">":return"&gt;"
case"&":return"&amp;"}})):""}!function(){if(p&&b){var e=ot.config,t=[],n=!1,r=Object.prototype.hasOwnProperty,i=S({filter:void 0,module:void 0,moduleId:void 0,testId:void 0}),o=null
ot.on("runStart",(function(e){ht.defined=e.testCounts.total})),ot.begin((function(t){!function(t){var n,s,a,u,l,f,g,v,E=T("qunit")
E&&(E.setAttribute("role","main"),E.innerHTML="<h1 id='qunit-header'>"+pt(b.title)+"</h1><h2 id='qunit-banner'></h2><div id='qunit-testrunner-toolbar' role='navigation'></div>"+(!(n=ot.config.testId)||n.length<=0?"":"<div id='qunit-filteredTest'>Rerunning selected tests: "+pt(n.join(", "))+" <a id='qunit-clearFilter' href='"+pt(i)+"'>Run all tests</a></div>")+"<h2 id='qunit-userAgent'></h2><ol id='qunit-tests'></ol>"),(s=T("qunit-header"))&&(s.innerHTML="<a href='"+pt(i)+"'>"+s.innerHTML+"</a> "),(a=T("qunit-banner"))&&(a.className=""),g=T("qunit-tests"),(v=T("qunit-testresult"))&&v.parentNode.removeChild(v),g&&(g.innerHTML="",(v=b.createElement("p")).id="qunit-testresult",v.className="result",g.parentNode.insertBefore(v,g),v.innerHTML='<div id="qunit-testresult-display">Running...<br />&#160;</div><div id="qunit-testresult-controls"></div><div class="clearfix"></div>',l=T("qunit-testresult-controls")),l&&l.appendChild(((f=b.createElement("button")).id="qunit-abort-tests-button",f.innerHTML="Abort",d(f,"click",C),f)),(u=T("qunit-userAgent"))&&(u.innerHTML="",u.appendChild(b.createTextNode("QUnit "+ot.version+"; "+y.userAgent))),function(t){var n,i,s,a,u,l=T("qunit-testrunner-toolbar")
...
e[s.id]&&!t&&(i+="<option value='"+(a=pt(e[s.id]))+"' selected='selected' disabled='disabled'>"+a+"</option>"),i+="</select>"}else i+="<label for='qunit-urlconfig-"+a+"' title='"+u+"'><input id='qunit-urlconfig-"+a+"' name='"+a+"' type='checkbox'"+(s.value?" value='"+pt(s.value)+"'":"")+(e[s.id]?" checked='checked'":"")+" title='"+u+"' />"+pt(s.label)+"</label>"}return i}(),k(u,"qunit-url-config"),m(u.getElementsByTagName("input"),"change",M),m(u.getElementsByTagName("select"),"change",M),u))
var f=b.createElement("span")
f.id="qunit-toolbar-filters",f.appendChild((n=b.createElement("form"),i=b.createElement("label"),s=b.createElement("input"),a=b.createElement("button"),k(n,"qunit-filter"),i.innerHTML="Filter: ",s.type="text",s.value=e.filter||"",s.name="filter",s.id="qunit-filter-input",a.innerHTML="Go",i.appendChild(s),n.appendChild(i),n.appendChild(b.createTextNode(" ")),n.appendChild(a),d(n,"submit",N),n)),f.appendChild(function(t){var n=null
...
l.textContent="Apply",l.title="Re-run the selected test modules",d(l,"click",j)
var f=b.createElement("button")
f.textContent="Reset",f.type="reset",f.title="Restore the previous module selection"
var g=b.createElement("button")
g.textContent="Select none",g.type="button",g.title="Clear the current module selection",d(g,"click",(function(){o.selectedMap.clear(),M(),C()}))
var m=b.createElement("span")
m.id="qunit-modulefilter-actions",m.appendChild(l),m.appendChild(f),n.size&&m.appendChild(g)
var v=b.createElement("ul")
v.id="qunit-modulefilter-dropdown-list"
var y=b.createElement("div")
y.id="qunit-modulefilter-dropdown",y.style.display="none",y.appendChild(m),y.appendChild(v),d(y,"change",M),u.appendChild(y),M()
var k,E=b.createElement("form")
function T(){function e(t){var n=E.contains(t.target)
27!==t.keyCode&&n||(27===t.keyCode&&n&&s.focus(),y.style.display="none",h(b,"click",e),h(b,"keydown",e),s.value="",C())}"none"===y.style.display&&(C(),y.style.display="block",d(b,"click",e),d(b,"keydown",e))}function C(){p.clearTimeout(k),k=p.setTimeout((function(){v.innerHTML=function(e){return function(e){var t=""
o.selectedMap.forEach((function(e,n){t+=q(n,e,!0)}))
for(var n=0;n<e.length;n++){var r=e[n].obj
o.selectedMap.has(r.moduleId)||(t+=q(r.moduleId,r.name,!1))}return t}(""===e?o.options.slice(0,20).map((function(e){return{obj:e}})):dt.go(e,o.options,{limit:20,key:"name",allowTypo:!0}))}(s.value)}))}function M(e){var t=e&&e.target||null
...
s.placeholder=n,s.title="Type to search through and reduce the list.",f.disabled=!o.isDirty(),g.style.display=o.selectedMap.size?"":"none"}return E.id="qunit-modulefilter",E.appendChild(a),E.appendChild(b.createTextNode(" ")),E.appendChild(u),d(E,"submit",N),d(E,"reset",(function(){o.selectedMap=new w(n),M(),C()})),E}(t))
var g=b.createElement("div")
g.className="clearfix",l.appendChild(f),l.appendChild(g)}}(t)}(t)})),ot.on("runEnd",(function(t){var n,r,i,o=T("qunit-banner"),s=T("qunit-tests"),a=T("qunit-abort-tests-button"),u=e.stats.all-e.stats.bad,l=[t.testCounts.total," tests completed in ",t.runtime," milliseconds, with ",t.testCounts.failed," failed, ",t.testCounts.skipped," skipped, and ",t.testCounts.todo," todo.<br />","<span class='passed'>",u,"</span> assertions of <span class='total'>",e.stats.all,"</span> passed, <span class='failed'>",e.stats.bad,"</span> failed.",O(ht.failedTests)].join("")
if(a&&a.disabled){l="Tests aborted after "+t.runtime+" milliseconds."
for(var c=0;c<s.children.length;c++)""!==(n=s.children[c]).className&&"running"!==n.className||(n.className="aborted",i=n.getElementsByTagName("ol")[0],(r=b.createElement("li")).className="fail",r.innerHTML="Test aborted.",i.appendChild(r))}!o||a&&!1!==a.disabled||(o.className="failed"===t.status?"qunit-fail":"qunit-pass"),a&&a.parentNode.removeChild(a),s&&(T("qunit-testresult-display").innerHTML=l),e.altertitle&&b.title&&(b.title=["failed"===t.status?"✖":"✔",b.title.replace(/^[\u2714\u2716] /i,"")].join(" ")),e.scrolltop&&p.scrollTo&&p.scrollTo(0,0)})),ot.testStart((function(e){var t,n
I(e.name,e.testId,e.module),(t=T("qunit-testresult-display"))&&(k(t,"running"),n=ot.config.reorder&&e.previousFailure,t.innerHTML=[A(ht),n?"Rerunning previously failed test: <br />":"Running: ",_(e.name,e.module),O(ht.failedTests)].join(""))})),ot.log((function(e){var t=T("qunit-test-output-"+e.testId)
...
c?k(a,"qunit-collapsed"):(ht.failedTests.push(r.testId),e.collapse&&(n?k(a,"qunit-collapsed"):n=!0))
...
p.className="qunit-skipped-label",p.innerHTML="skipped",o.insertBefore(p,f)}else{if(d(f,"click",(function(){x(a,"qunit-collapsed")})),o.className=c?"pass":"fail",r.todo){var g=b.createElement("em")
g.className="qunit-todo-label",g.innerHTML="todo",o.className+=" todo",o.insertBefore(g,f)}var m=b.createElement("span")
m.className="runtime",m.innerHTML=r.runtime+" ms",o.insertBefore(m,a)}if(r.source){var v=b.createElement("p")
v.innerHTML="<strong>Source: </strong>"+pt(r.source),k(v,"qunit-source"),c&&k(v,"qunit-collapsed"),d(f,"click",(function(){x(v,"qunit-collapsed")})),o.appendChild(v)}e.hidepassed&&("passed"===s||r.skipped)&&(t.push(o),i.removeChild(o))}})),ot.on("error",(function(e){var t=I("global failure")
if(t){var n=pt(L(e))
...
var s,a=(s=p.phantom)&&s.version&&s.version.major>0
a&&g.warn("Support for PhantomJS is deprecated and will be removed in QUnit 3.0."),a||"complete"!==b.readyState?d(p,"load",ot.load):ot.load()
var u=p.onerror
p.onerror=function(t,n,r,i,o){var s=!1
...
var f=o||new Error(t)
!f.stack&&n&&r&&(f.stack="".concat(n,":").concat(r)),ot.onUncaughtException(f)}return s},p.addEventListener("unhandledrejection",(function(e){ot.onUncaughtException(e.reason)}))}function l(e){return"function"==typeof e.trim?e.trim():e.replace(/^\s+|\s+$/g,"")}function d(e,t,n){e.addEventListener(t,n,!1)}function h(e,t,n){e.removeEventListener(t,n,!1)}function m(e,t,n){for(var r=e.length;r--;)d(e[r],t,n)}function v(e,t){return(" "+e.className+" ").indexOf(" "+t+" ")>=0}function k(e,t){v(e,t)||(e.className+=(e.className?" ":"")+t)}function x(e,t,n){n||void 0===n&&!v(e,t)?k(e,t):E(e,t)}function E(e,t){for(var n=" "+e.className+" ";n.indexOf(" "+t+" ")>=0;)n=n.replace(" "+t+" "," ")
e.className=l(n)}function T(e){return b.getElementById&&b.getElementById(e)}function C(){var e=T("qunit-abort-tests-button")
return e&&(e.disabled=!0,e.innerHTML="Aborting..."),ot.config.queue.length=0,!1}function N(e){var t=T("qunit-filter-input")
return t.value=l(t.value),j(),e&&e.preventDefault&&e.preventDefault(),!1}function M(){var n,r=this,i={}
n="selectedIndex"in r?r.options[r.selectedIndex].value||void 0:r.checked?r.defaultValue||!0:void 0,i[r.name]=n
var o=S(i)
if("hidepassed"===r.name&&"replaceState"in p.history){ot.urlParams[r.name]=n,e[r.name]=n||!1
var s=T("qunit-tests")
if(s){var a=s.children.length,u=s.children
if(r.checked){for(var l=0;l<a;l++){var c=u[l],d=c?c.className:"",h=d.indexOf("pass")>-1,g=d.indexOf("skipped")>-1;(h||g)&&t.push(c)}var m,v=function(e,t){var n="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"]
...
s.removeChild(b)}}catch(e){v.e(e)}finally{v.f()}}else for(var y;null!=(y=t.pop());)s.appendChild(y)}p.history.replaceState(null,"",o)}else p.location=o}function S(e){var t="?",n=p.location
for(var i in e=R(R({},ot.urlParams),e))if(r.call(e,i)&&void 0!==e[i])for(var o=[].concat(e[i]),s=0;s<o.length;s++)t+=encodeURIComponent(i),!0!==o[s]&&(t+="="+encodeURIComponent(o[s])),t+="&"
return n.protocol+"//"+n.host+n.pathname+t.slice(0,-1)}function j(){var e=T("qunit-filter-input").value
p.location=S({filter:""===e?void 0:e,moduleId:c(o.selectedMap.keys()),module:void 0,testId:void 0})}function q(e,t,n){return'<li><label class="clickable'+(n?" checked":"")+'"><input type="checkbox" value="'+pt(e)+'"'+(n?' checked="checked"':"")+" />"+pt(t)+"</label></li>"}function I(e,t,n){var r=T("qunit-tests")
if(r){var i=b.createElement("strong")
i.innerHTML=_(e,n)
var o=b.createElement("li")
if(o.appendChild(i),void 0!==t){var s=b.createElement("a")
s.innerHTML="Rerun",s.href=S({testId:t}),o.id="qunit-test-output-"+t,o.appendChild(s)}var a=b.createElement("ol")
return a.className="qunit-assert-list",o.appendChild(a),r.appendChild(o),o}}function O(e){return 0===e.length?"":["<br /><a href='"+pt(S({testId:e}))+"'>",1===e.length?"Rerun 1 failed test":"Rerun "+e.length+" failed tests","</a>"].join("")}function _(e,t){var n=""
return t&&(n="<span class='module-name'>"+pt(t)+"</span>: "),n+"<span class='test-name'>"+pt(e)+"</span>"}function A(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function P(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),ot.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
...
for(l[a+1]=0,c[a+1]=0,h=(d=i-o)%2!=0,p=0,g=0,m=0,v=0,T=0;T<s&&!(Date.now()>r);T++){for(C=-T+p;C<=T-g;C+=2){for(y=a+C,x=(k=C===-T||C!==T&&l[y-1]<l[y+1]?l[y+1]:l[y-1]+1)-C;k<i&&x<o&&e.charAt(k)===n.charAt(x);)k++,x++
if(l[y]=k,k>i)g+=2
else if(x>o)p+=2
