...
t[n]=r[n]}}return t}
const p=function(){for(var t=arguments.length,e=new Array(t),r=0;r<t;r++)e[r]=arguments[r]
return e}
function d(t){return t.length>0}function m(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"unexpected empty list"
if(!d(t))throw new Error(e)}"function"==typeof Symbol&&"symbol"==typeof Symbol()&&Symbol,[1,2,3].forEach((t=>t)),[1,-1].forEach((t=>{return function(t){return(t|=0)>-536870913?function(t){return~t}(t):function(t){return 536870912|t}(t)}((e=t,(e|=0)<0?function(t){return-536870913&t}(e):function(t){return~t}(e)))
...
class A{constructor(t){this.data=t}static forHbsPos(t,e){return new C(t,e,null).wrap()}static broken(){return new D("Broken",arguments.length>0&&void 0!==arguments[0]?arguments[0]:g).wrap()}get offset(){let t=this.data.toCharPos()
...
this._locPos=t=null===e?N:new C(this.source,e,this.charPos)}return t===N?null:t}}class C{constructor(t,e){let r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null
this.source=t,this.hbsPos=e,this.kind="HbsPosition",this._charPos=null===r?null:new L(t,r)}toCharPos(){let t=this._charPos
if(null===t){let e=this.source.charPosFor(this.hbsPos)
this._charPos=t=null===e?N:new L(this.source,e)}return t===N?null:t}toJSON(){return this.hbsPos}wrap(){return new A(this)}toHbsPos(){return this}}class D{constructor(t,e){this.kind=t,this.pos=e}toCharPos(){return null}toJSON(){return this.pos}wrap(){return new A(this)}get offset(){return null}}const B=T((t=>t.when("HbsPosition","HbsPosition",((t,e)=>{let{hbsPos:r}=t,{hbsPos:s}=e
return r.column===s.column&&r.line===s.line})).when("CharPosition","CharPosition",((t,e)=>{let{charPos:r}=t,{charPos:s}=e
return r===s})).when("CharPosition","HbsPosition",((t,e)=>{let{offset:r}=t
var s
return r===(null===(s=e.toCharPos())||void 0===s?void 0:s.offset)})).when("HbsPosition","CharPosition",((t,e)=>{let{offset:r}=e
var s
return(null===(s=t.toCharPos())||void 0===s?void 0:s.offset)===r})).when(w,w,(()=>!1))))
class _{constructor(t){this.data=t,this.isInvisible="CharPosition"!==t.kind&&"HbsPosition"!==t.kind}static get NON_EXISTENT(){return new I("NonExistent",y).wrap()}static load(t,e){return"number"==typeof e?_.forCharPositions(t,e,e):"string"==typeof e?_.synthetic(e):Array.isArray(e)?_.forCharPositions(t,e[0],e[1]):"NonExistent"===e?_.NON_EXISTENT:"Broken"===e?_.broken(v):void function(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"unexpected unreachable branch"
throw f.log("unreachable",t),f.log(`${e} :: ${JSON.stringify(t)} (${t})`),new Error("code reached unreachable")}(e)}static forHbsLoc(t,e){let r=new C(t,e.start),s=new C(t,e.end)
return new O(t,{start:r,end:s},e).wrap()}static forCharPositions(t,e,r){let s=new L(t,e),n=new L(t,r)
return new q(t,{start:s,end:n}).wrap()}static synthetic(t){return new I("InternalsSynthetic",y,t).wrap()}static broken(){return new I("Broken",arguments.length>0&&void 0!==arguments[0]?arguments[0]:v).wrap()}getStart(){return this.data.getStart().wrap()}getEnd(){return this.data.getEnd().wrap()}get loc(){let t=this.data.toHbsSpan()
...
case"end":return this.getEnd().collapsed()}}extend(t){return H(this.data.getStart(),t.data.getEnd())}serialize(){return this.data.serialize()}slice(t){let{skipStart:e=0,skipEnd:r=0}=t
return H(this.getStart().move(e).data,this.getEnd().move(-r).data)}sliceStartChars(t){let{skipStart:e=0,chars:r}=t
return H(this.getStart().move(e).data,this.getStart().move(e+r).data)}sliceEndChars(t){let{skipEnd:e=0,chars:r}=t
return H(this.getEnd().move(e-r).data,this.getStart().move(-e).data)}}class q{constructor(t,e){this.source=t,this.charPositions=e,this.kind="CharPosition",this._locPosSpan=null}wrap(){return new _(this)}asString(){return this.source.slice(this.charPositions.start.charPos,this.charPositions.end.charPos)}getModule(){return this.source.module}getStart(){return this.charPositions.start}getEnd(){return this.charPositions.end}locDidUpdate(){}toHbsSpan(){let t=this._locPosSpan
...
return t===e?t:[t,e]}toCharPosSpan(){return this}}class O{constructor(t,e){let r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null
this.source=t,this.hbsPositions=e,this.kind="HbsPosition",this._charPosSpan=null,this._providedHbsLoc=r}serialize(){let t=this.toCharPosSpan()
return null===t?"Broken":t.wrap().serialize()}wrap(){return new _(this)}updateProvided(t,e){this._providedHbsLoc&&(this._providedHbsLoc[e]=t),this._charPosSpan=null,this._providedHbsLoc={start:t,end:t}}locDidUpdate(t){let{start:e,end:r}=t
void 0!==e&&(this.updateProvided(e,"start"),this.hbsPositions.start=new C(this.source,e,null)),void 0!==r&&(this.updateProvided(r,"end"),this.hbsPositions.end=new C(this.source,r,null))}asString(){let t=this.toCharPosSpan()
...
t=this._charPosSpan=new q(this.source,{start:e,end:r})}return t===N?null:t}}class I{constructor(t,e){let r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null
this.kind=t,this.loc=e,this.string=r}serialize(){switch(this.kind){case"Broken":case"NonExistent":return this.kind
case"InternalsSynthetic":return this.string||""}}wrap(){return new _(this)}asString(){return this.string||""}locDidUpdate(t){let{start:e,end:r}=t
void 0!==e&&(this.loc.start=e),void 0!==r&&(this.loc.end=r)}getModule(){return"an unknown module"}getStart(){return new D(this.kind,this.loc.start)}getEnd(){return new D(this.kind,this.loc.end)}toCharPosSpan(){return this}toHbsSpan(){return null}toHbsLoc(){return v}}const H=T((t=>t.when("HbsPosition","HbsPosition",((t,e)=>new O(t.source,{start:t,end:e}).wrap())).when("CharPosition","CharPosition",((t,e)=>new q(t.source,{start:t,end:e}).wrap())).when("CharPosition","HbsPosition",((t,e)=>{let r=e.toCharPos()
...
class V{constructor(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"an unknown module"
this.source=t,this.module=e}check(t){return t>=0&&t<=this.source.length}slice(t,e){return this.source.slice(t,e)}offsetFor(t,e){return A.forHbsPos(this,{line:t,column:e})}spanFor(t){let{start:e,end:r}=t
return _.forHbsLoc(this,{start:{line:e.line,column:e.column},end:{line:r.line,column:r.column}})}hbsPosFor(t){let e=0,r=0
...
return new R(t,r,s,Q(e||null))}function K(t,e,r){return{type:t,value:e,original:e,loc:Q(r||null)}}function J(t,e){return{type:"Hash",pairs:t||[],loc:Q(e||null)}}function Q(){for(var t=arguments.length,e=new Array(t),r=0;r<t;r++)e[r]=arguments[r]
if(1===e.length){let t=e[0]
return t&&"object"==typeof t?_.forHbsLoc(F(),t):_.forHbsLoc(F(),b)}{let[t,r,s,n,a]=e,i=a?new V("",a):F()
return _.forHbsLoc(i,{start:{line:t,column:r},end:{line:s,column:n}})}}const Y={mustache:function(t,e,r,s,n,a){return"string"==typeof t&&(t=W(t)),{type:"MustacheStatement",path:t,params:e||[],hash:r||J([]),escaped:!s,trusting:!!s,loc:Q(n||null),strip:a||{open:!1,close:!1}}},block:function(t,e,r,s,n,a,i,o,l){let c,h
...
return{type:"ConcatStatement",parts:t||[],loc:Q(e||null)}},hash:J,pair:function(t,e,r){return{type:"HashPair",key:t,value:e,loc:Q(r||null)}},literal:K,program:function(t,e,r){return{type:"Template",body:t||[],blockParams:e||[],loc:Q(r||null)}},blockItself:function(t,e){let r=arguments.length>2&&void 0!==arguments[2]&&arguments[2],s=arguments.length>3?arguments[3]:void 0
return{type:"Block",body:t||[],blockParams:e||[],chained:r,loc:Q(s||null)}},template:function(t,e,r){return{type:"Template",body:t||[],blockParams:e||[],loc:Q(r||null)}},loc:Q,pos:function(t,e){return{line:t,column:e}},path:W,fullPath:function(t,e,r){let{original:s,parts:n}=U(t),a=[...s,...n,...e].join(".")
...
class et{constructor(t){let e=arguments.length>1&&void 0!==arguments[1]&&arguments[1]
this.ambiguity=t,this.isAngleBracket=e}static namespaced(t){return new et({namespaces:[t],fallback:!1},arguments.length>1&&void 0!==arguments[1]&&arguments[1])}static fallback(){return new et({namespaces:[],fallback:!0})}static append(t){let{invoke:e}=t
return new et({namespaces:["Component","Helper"],fallback:!e})}static trustingAppend(t){let{invoke:e}=t
return new et({namespaces:["Helper"],fallback:!e})}static attr(){return new et({namespaces:["Helper"],fallback:!0})}resolution(){if(0===this.ambiguity.namespaces.length)return 31
...
return e?e.value:null}isEmpty(){return 0===this.entries.length}}class lt{constructor(t){this.loc=t.name.loc.extend(t.value.loc),this.name=t.name,this.value=t.value}}class ct extends(nt("HtmlAttr").fields()){}class ht extends(nt("SplatAttr").fields()){}class ut extends(nt().fields()){toNamedArgument(){return new lt({name:this.name,value:this.value})}}class pt extends(nt("ElementModifier").fields()){}class dt{constructor(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[]
this._span=t}static range(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:_.NON_EXISTENT
...
const Gt=/\S/
class Wt{constructor(t){this.buffer="",this.options=t}handledByOverride(t){let e=arguments.length>1&&void 0!==arguments[1]&&arguments[1]
if(void 0!==this.options.override){let r=this.options.override(t,this.options)
...
throw r.hash=e,r}this.trace(t)},parse:function(t){var e=this,r=[0],s=[null],n=[],a=this.table,i="",o=0,l=0,c=0,h=2,u=1,p=n.slice.call(arguments,1),d=Object.create(this.lexer),m={yy:{}}
for(var f in this.yy)Object.prototype.hasOwnProperty.call(this.yy,f)&&(m.yy[f]=this.yy[f])
d.setInput(t,m.yy),m.yy.lexer=d,m.yy.parser=this,void 0===d.yylloc&&(d.yylloc={})
var g=d.yylloc
n.push(g)
...
for(var y,v,k,w,S,E,P,T,x,N=function(){var t
return"number"!=typeof(t=d.lex()||u)&&(t=e.symbols_[t]||t),t},A={};;){if(k=r[r.length-1],this.defaultActions[k]?w=this.defaultActions[k]:(null==y&&(y=N()),w=a[k]&&a[k][y]),void 0===w||!w.length||!w[0]){var L=""
for(E in x=[],a[k])this.terminals_[E]&&E>h&&x.push("'"+this.terminals_[E]+"'")
L=d.showPosition?"Parse error on line "+(o+1)+":\n"+d.showPosition()+"\nExpecting "+x.join(", ")+", got '"+(this.terminals_[y]||y)+"'":"Parse error on line "+(o+1)+": Unexpected "+(y==u?"end of input":"'"+(this.terminals_[y]||y)+"'"),this.parseError(L,{text:d.match,token:this.terminals_[y]||y,line:d.yylineno,loc:g,expected:x})}if(w[0]instanceof Array&&w.length>1)throw new Error("Parse Error: multiple actions possible at state: "+k+", token: "+y)
switch(w[0]){case 1:r.push(y),s.push(d.yytext),n.push(d.yylloc),r.push(w[1]),y=null,v?(y=v,v=null):(l=d.yyleng,i=d.yytext,o=d.yylineno,g=d.yylloc,c>0&&c--)
break
case 2:if(P=this.productions_[w[1]][1],A.$=s[s.length-P],A._$={first_line:n[n.length-(P||1)].first_line,last_line:n[n.length-1].last_line,first_column:n[n.length-(P||1)].first_column,last_column:n[n.length-1].last_column},b&&(A._$.range=[n[n.length-(P||1)].range[0],n[n.length-1].range[1]]),void 0!==(S=this.performAction.apply(A,[i,l,o,m.yy,w[1],s,n].concat(p))))return S
P&&(r=r.slice(0,-1*P*2),s=s.slice(0,-1*P),n=n.slice(0,-1*P)),r.push(this.productions_[w[1]][0]),s.push(A.$),n.push(A._$),T=a[r[r.length-2]][r[r.length-1]],r.push(T)
break
...
function He(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{entityEncoding:"transformed"}
if(!t)return""
let r=new Wt(e)
return r.print(t)}function Ve(t,e){let{module:r,loc:s}=e,{line:n,column:a}=s.start,i=e.asString(),o=i?`\n\n|\n|  ${i.split("\n").join("\n|  ")}\n|\n\n`:"",l=new Error(`${t}: ${o}(error occurred in '${r}' @ line ${n} : column ${a})`)
...
case"ElementNode":return t.children}})(t).push(e)}function nr(t){return"StringLiteral"===t.type||"BooleanLiteral"===t.type||"NumberLiteral"===t.type||"NullLiteral"===t.type||"UndefinedLiteral"===t.type}function ar(t){return t[0]===t[0].toUpperCase()&&t[0]!==t[0].toLowerCase()}const ir={close:!1,open:!1},or=new class{pos(t,e){return{line:t,column:e}}blockItself(t){let{body:e,blockParams:r,chained:s=!1,loc:n}=t
return{type:"Block",body:e||[],blockParams:r||[],chained:s,loc:n}}template(t){let{body:e,blockParams:r,loc:s}=t
return{type:"Template",body:e||[],blockParams:r||[],loc:s}}mustache(t){let{path:e,params:r,hash:s,trusting:n,loc:a,strip:i=ir}=t
return{type:"MustacheStatement",path:e,params:r,hash:s,escaped:!n,trusting:n,loc:a,strip:i||{open:!1,close:!1}}}block(t){let{path:e,params:r,hash:s,defaultBlock:n,elseBlock:a=null,loc:i,openStrip:o=ir,inverseStrip:l=ir,closeStrip:c=ir}=t
return{type:"BlockStatement",path:e,params:r,hash:s,program:n,inverse:a,loc:i,openStrip:o,inverseStrip:l,closeStrip:c}}comment(t,e){return{type:"CommentStatement",value:t,loc:e}}mustacheComment(t,e){return{type:"MustacheCommentStatement",value:t,loc:e}}concat(t,e){return{type:"ConcatStatement",parts:t,loc:e}}element(t){let{tag:e,selfClosing:r,attrs:s,blockParams:n,modifiers:a,comments:i,children:o,loc:l}=t
return{type:"ElementNode",tag:e,selfClosing:r,attributes:s||[],blockParams:n||[],modifiers:a||[],comments:i||[],children:o||[],loc:l}}elementModifier(t){let{path:e,params:r,hash:s,loc:n}=t
return{type:"ElementModifierStatement",path:e,params:r,hash:s,loc:n}}attr(t){let{name:e,value:r,loc:s}=t
return{type:"AttrNode",name:e,value:r,loc:s}}text(t){let{chars:e,loc:r}=t
return{type:"TextNode",chars:e,loc:r}}sexpr(t){let{path:e,params:r,hash:s,loc:n}=t
return{type:"SubExpression",path:e,params:r,hash:s,loc:n}}path(t){let{head:e,tail:r,loc:s}=t,{original:n}=function(t){switch(t.type){case"AtHead":case"VarHead":return{original:t.name,parts:[t.name]}
case"ThisHead":return{original:"this",parts:[]}}}(e),a=[...n,...r].join(".")
return new R(a,e,r,s)}head(t,e){return"@"===t[0]?this.atName(t,e):"this"===t?this.this(e):this.var(t,e)}this(t){return{type:"ThisHead",loc:t}}atName(t,e){return{type:"AtHead",name:t,loc:e}}var(t,e){return{type:"VarHead",name:t,loc:e}}hash(t,e){return{type:"Hash",pairs:t||[],loc:e}}pair(t){let{key:e,value:r,loc:s}=t
return{type:"HashPair",key:e,value:r,loc:s}}literal(t){let{type:e,value:r,loc:s}=t
return{type:e,value:r,original:r,loc:s}}undefined(){return this.literal({type:"UndefinedLiteral",value:void 0})}null(){return this.literal({type:"NullLiteral",value:null})}string(t,e){return this.literal({type:"StringLiteral",value:t,loc:e})}boolean(t,e){return this.literal({type:"BooleanLiteral",value:t,loc:e})}number(t,e){return this.literal({type:"NumberLiteral",value:t,loc:e})}}
class lr{constructor(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:new Ce(xe),r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"precompile"
...
class mr extends Ce{constructor(){super({})}parse(){}}function fr(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
var r,s,n
...
return Object.keys(t).map((e=>t[e]))}setHasEval(){this.parent.setHasEval()}allocateFree(t,e){return this.parent.allocateFree(t,e)}allocateNamed(t){return this.parent.allocateNamed(t)}allocateBlock(t){return this.parent.allocateBlock(t)}allocate(t){return this.parent.allocate(t)}}class vr{template(t,e,r){return new qt({table:t,body:e,loc:r})}block(t,e,r){return new Ot({scope:t,body:e,loc:r})}namedBlock(t,e,r){return new Ht({name:t,block:e,attrs:[],componentArgs:[],modifiers:[],loc:r})}simpleNamedBlock(t,e,r){return new kr({selfClosing:!1,attrs:[],componentArgs:[],modifiers:[],comments:[]}).named(t,e,r)}slice(t,e){return new k({loc:e,chars:t})}args(t,e,r){return new at({loc:r,positional:t,named:e})}positional(t,e){return new it({loc:e,exprs:t})}namedArgument(t,e){return new lt({name:t,value:e})}named(t,e){return new ot({loc:e,entries:t})}attr(t,e){let{name:r,value:s,trusting:n}=t
return new ct({loc:e,name:r,value:s,trusting:n})}splatAttr(t,e){return new ht({symbol:t,loc:e})}arg(t,e){let{name:r,value:s,trusting:n}=t
return new ut({name:r,value:s,trusting:n,loc:e})}path(t,e,r){return new xt({loc:r,ref:t,tail:e})}self(t){return new Ct({loc:t})}at(t,e,r){return new Dt({loc:r,name:new k({loc:r,chars:t}),symbol:e})}freeVar(t){let{name:e,context:r,symbol:s,loc:n}=t
return new _t({name:e,resolution:r,symbol:s,loc:n})}localVar(t,e,r,s){return new Bt({loc:s,name:t,isTemplateLocal:r,symbol:e})}sexp(t,e){return new Nt({loc:e,callee:t.callee,args:t.args})}deprecatedCall(t,e,r){return new At({loc:r,arg:t,callee:e})}interpolate(t,e){return m(t),new Lt({loc:e,parts:t})}literal(t,e){return new Pt({loc:e,value:t})}append(t,e){let{table:r,trusting:s,value:n}=t
return new kt({table:r,trusting:s,value:n,loc:e})}modifier(t,e){let{callee:r,args:s}=t
return new pt({loc:e,callee:r,args:s})}namedBlocks(t,e){return new It({loc:e,blocks:t})}blockStatement(t,e){var{symbols:r,program:s,inverse:n=null}=t,a=function(t,e){var r={}
...
return new St(u({loc:s,callee:t,blocks:this.builder.namedBlocks([a],a.loc)},this.base))}componentWithNamedBlocks(t,e,r){return new St(u({loc:r,callee:t,blocks:this.builder.namedBlocks(e,dt.range(e))},this.base))}}function wr(t){return Tr(t)?et.namespaced("Helper"):null}function Sr(t){return Tr(t)?et.namespaced("Modifier"):null}function Er(t){return Tr(t)?et.namespaced("Component"):et.fallback()}function Pr(t){return xr(t)?et.namespaced("Component",!0):null}function Tr(t){return xr(t.path)}function xr(t){return"PathExpression"===t.type&&"VarHead"===t.head.type&&0===t.tail.length}function Nr(t){return t.params.length>0||t.hash.pairs.length>0}function Ar(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
var r
let s=fr(t,e),n=u({strictMode:!1,locals:[]},e),a=gr.top(n.locals,null!==(r=e.customizeComponentName)&&void 0!==r?r:t=>t),i=new Lr(t,n,a),o=new Dr(i),l=new qr(i.loc(s.loc),s.body.map((t=>o.normalize(t))),i).assertTemplate(a),c=a.getUsedTemplateLocals()
return[l,c]}class Lr{constructor(t,e,r){this.source=t,this.options=e,this.table=r,this.builder=new vr}get strict(){return this.options.strictMode||!1}loc(t){return this.source.spanFor(t)}resolutionFor(t,e){if(this.strict)return{resolution:tt}
...
return s}}(e,r,s);(Array.isArray(n)?n:[n]).forEach((e=>{void 0!==e&&"@"!==e[0]&&t.add(e.split(".")[0])}))}function Ur(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{includeHtmlElements:!1,includeKeywords:!1}
const r=fr(t),s=new Set,n=[]
Xe(r,{Block:{enter(t){let{blockParams:e}=t
e.forEach((t=>{n.push(t)}))},exit(t){let{blockParams:e}=t
e.forEach((()=>{n.pop()}))}},ElementNode:{enter(t){t.blockParams.forEach((t=>{n.push(t)})),Fr(s,t,n,e)},exit(t){let{blockParams:e}=t
...
n=s.params.length>1?this.sourceForLoc({start:s.params[0].loc.end,end:s.params[1].loc.start}):e.hadParams?e.postPathWhitespace:e.hadHash?e.postParamsWhitespace:" ",""!==n.trim()&&(n=" "),e.paramsSource=t.params.map((t=>this.print(t))).join(n),e.hadParams&&0===t.params.length?e.postPathWhitespace="":!e.hadParams&&t.params.length>0&&(e.postPathWhitespace=n),r.delete("params")}}print(){let t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:this._originalAst
var e
if(!t)return""
...
default:return(0,s.print)(t,{entityEncoding:"raw",override:t=>{if(this.nodeInfo.has(t)||(0,a.useCustomPrinter)(t))return this.print(t)}})}}}},9006:(t,e)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.getLines=e.compactJoin=e.compact=e.sortByLoc=e.isSyntheticWithNoLocation=e.sourceForLoc=void 0
const r=/(.*?(?:\r\n?|\n|$))/gm
...
return c.join("")},e.isSyntheticWithNoLocation=s,e.sortByLoc=function(t,e){return s(t)||s(e)?0:t.loc.start.line<e.loc.start.line||t.loc.start.line===e.loc.start.line&&t.loc.start.column<e.loc.start.column?-1:t.loc.start.line===e.loc.start.line&&t.loc.start.column===e.loc.start.column?0:1},e.compact=n,e.compactJoin=function(t){let e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:""
return n(t).join(e)},e.getLines=a}}])
